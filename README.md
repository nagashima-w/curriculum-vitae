...
- 資本金 1050万円
- 役職 チームリーダー
  - 役職名はチームリーダーだが、実際にはメンバーのマネジメントを行っており一般的には課長相当の役職
- 所属 2024/04 〜 現在
...
- 2024/04~2025/03
  - エンジニアリング本部インフラSREチーム
    - リバースプロキシとネットワーク機器リプレースのプロジェクトマネジメント
    - 社内のGoogle Cloud状況整理
    - チームビルディングワークショップ企画
- 2024/10~現在
  - エンジニアリング本部DXサービスチーム（チームリーダー）
    - チームのマネジメント全般
    - 要件定義や業務フロー整理
- 2025/04~現在
  - エンジニアリング本部データ基盤チーム（チームリーダー）
    - チームのマネジメント全般
    - ビジネスサイドと関係構築しながらデータ分析企画

#### サマリ

- 振り返り会をはじめとしたチームのワークショップの企画と実施
- プロマネ業
  - リバースプロキシのリプレース
...
- インフラエンジニアだけではなく、ソフトウェアエンジニア、データエンジニアのマネジメントを担当した
- 部門直下の課となったため、年度の予算計画や人員計画の作成も実施した
