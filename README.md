...
- 新しいことに柔軟に対応できる
  - これまでの業務において知見がない技術を取り扱う機会が多く、その都度キャッチアップとアウトプットができてきている
    - 前職ではtd-agent、現職ではInfrastructure as CodeやGit、AWSのサービス全般が該当
...
- CI/CDパイプラインを組むのが好き
  - 友人との個人開発プロジェクトではGitHub～CiecleCI～リポジトリに応じた先のFirebase Deployを担当している
- Kubernates
...
- 証券会社向けサーバー/クライアントリプレース (2週間)
  ...
  - 物理サーバーのキッティング及びクライアント端末とのネットワーク設定、プロキシ設定を担当
